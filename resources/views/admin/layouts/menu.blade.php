<div class="app-sidebar">
    <div class="logo">
        <a href="{{route('logout')}}" class="logo-icon"><span class="logo-text">Вийти</span></a>
        <div class="sidebar-user-switcher user-activity-online">
            <a href="{{route('home')}}" target="_blank"> Admin
                <img src="/admin/assets/images/avatars/avatar.png">
    ...
    <div class="app-menu">
        <ul class="accordion-menu">
            ...
            <li @if (Route::is('admin.rubric'))class="active-page"@endif>
                <a href="{{route('admin.rubric')}}"><i class="material-icons-two-tone">bookmark</i>Рубріки</a>
            </li>
