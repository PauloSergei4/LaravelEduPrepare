    ...
    <div class="content-wrapper">
        <div class="container">
                            ...
                            <div class="widget-payment-request-container">
                                ...
                                <div class="widget-payment-request-product">
                                    <div class="widget-payment-request-product-image m-r-sm">
                                        <img src="/admin/assets/images/other/facebook_logo.png" class="mt-auto" alt="">
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="widget-popular-product-container">
                                <div class="widget-popular-product-image">
                                    <img src="/admin/assets/images/widgets/popular-product.jpeg" alt="">
                                </div>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="card">
                        <img src="/admin/assets/images/widgets/blog5.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <div class="card widget widget-info">
                        <div class="card-body">
                            <div class="widget-info-container">
                                <div class="widget-info-image" style="background: url('/admin/assets/images/widgets/security.svg')"></div>
                        ...
                        <div class="card-body">
                            <div class="widget-popular-blog-container">
                                <div class="widget-popular-blog-image">
                                    <img src="/admin/assets/images/widgets/product2.jpeg" alt="">
                                </div>
